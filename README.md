...
### ステップ22: タスクをカテゴライズできるようにしよう ★ スキップ可能

- 3階層までのカテゴリを用意しタスクを分類できるように追加してみましょう
  - 例として
    - 大カテゴリ: メンズ
    - 中カテゴリ: トップス
    - 小カテゴリ: Tシャツ
- カテゴリでタスクを検索できるようにしてみましょう
- ※ カテゴリの実装について
  - 1. タスク登録時のカテゴリの表示について
    - 大カテゴリを選んだら、中カテゴリを取得して表示し、
    - 中カテゴリを選んだら、小カテゴリを取得して表示するように
  - 2. カテゴリ取得にあたりjavascriptを用いて非同期処理にて取得するようにしましょう
