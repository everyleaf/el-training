...
### ステップ22: ユーザに住所情報を追加しよう ★ スキップ可能

- ユーザに住所情報を持たせられるようにしよう
- 郵便番号で住所検索できるようにしよう
- ※ 住所マスタとなるデータは、[こちら](https://www.post.japanpost.jp/zipcode/download.html)から入手できます。また、データは多いので全て取り込む必要はありません。例) 東京都世田谷区あたりまでにするなど
